...
import { verifyUser } from "../middlewares/verifyUser.js";
import { addAssignedAsset, getAllAssignedAsset, getMyAssignedAsset } from "../controllers/assignedAssetController.js";
...
assignedAssetRouter.get("/MyAssets",verifyUser,getMyAssignedAsset)
